...
import { getFriends, getOutgoingRequests, getRecommendedUsers, sendFriendRequest } from '../lib/api';
...
const friends = Array.isArray(friendsData?.friends) ? friendsData.friends : [];
  ...
  const recommendedUsers = Array.isArray(recommendedUsersData?.recommendedUsers)
    ...
    const { data: outgoingRequestsData, isLoading: loadingOngoingRequests } = useQuery({
      queryKey: ["outgoingRequests"],
      queryFn: getOutgoingRequests
    });
    
    const outgoingRequests = Array.isArray(outgoingRequestsData?.outgoingRequests)
      ? outgoingRequestsData.outgoingRequests
      : [];
